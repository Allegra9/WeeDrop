...
seller1 = Seller.create(name: "Allegra's Alcove", address: "Europe's Biggest Weed Farm", postcode: 'N1 7RF')
...
#3
Product.create(name: "Super Silver Haze (Sativa)", price: 13.00, description: "Super Silver Haze is a sativa cousin of Super Lemon Haze.", seller_id: 2 )
Product.create(name: "Acapulco Gold(Sativa)", price: 15.00, description: "Struck a Mexican Gold mine", seller_id: 2 )
Product.create(name: "Panama Red (Sativa)", price: 13.00, description: "Panama Red is an old-school cannabis classic. ", seller_id: 2 )
Product.create(name: "Lamb's Bread (Sativa)", price: 18.00, description: "Lamb's Bread, also known as Lamb's Breath, is a well-known and pungent sativa strain.", seller_id: 2 )
#7
...
Product.create(name: "Granddaddy Purple (Indica)", price: 13.00, description: "Granddaddy Purple (or GDP) is a famous indica cross between Purple Urkle and Big Bud.", seller_id: 3 )
Product.create(name: "Organic OG (Indica)", price: 16.00, description: "Grown on holy land, only watered with the tears of virgins, and only picked on a full moon", seller_id: 3 )
#10
...
Product.create(name: "THC Bomb (Hybrid)", price: 15.00, description: "THC Bomb is a nuclear experience that will blow your mind", seller_id: 4 )
